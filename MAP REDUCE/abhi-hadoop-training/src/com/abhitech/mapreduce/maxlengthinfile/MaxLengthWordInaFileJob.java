...
public class MaxLengthWordInaFileJob implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName("Abhitech MaxLengthWordInaFile Job");
		job.setJarByClass(this.getClass());
		job.setMapperClass(MaxLengthWordInaFileMapper.class);
		job.setReducerClass(MaxLengthWordInaFileReducer.class);
